...
import com.yeasinrabbi.RabindranathTagoreQuote.Beans.ListAdapter;
import com.yeasinrabbi.RabindranathTagoreQuote.Beans.ListModel;
import com.yeasinrabbi.RabindranathTagoreQuote.Db.Helper;
import com.yeasinrabbi.RabindranathTagoreQuote.R;
import com.yeasinrabbi.RabindranathTagoreQuote.Utils.Constant;
import com.yeasinrabbi.RabindranathTagoreQuote.Utils.RatingDialog;
import com.yeasinrabbi.RabindranathTagoreQuote.Utils.SaveData;
...
*/
    ...
    private void Notification() {
        ...
        if (!dialogShown) {
            ...
            Intent intentOne = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id" + Constant.promo_apps2));
            Intent intenttwo = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id" + Constant.promo_apps3));


            notificationOne(this, "জাফর ইকবাল সমগ্র", " জাফর ইকবাল স্যারের সব সবকিছু একটি অ্যাপে  ।", "About", "জাফর ইকবাল স্যারের সমস্ত রকম রচনা সমগ্র পেতে এখনি ডাউনলোড করুন অ্যাপটি", intentOne, 101);
            notificationtwo(this, "রবীন্দ্রনাথ ঠাকুর সমগ্র", " এই অ্যাপটি সমস্ত রবীন্দ্রনাথ বাংলা ভাষা প্রেমিদের জন্য ।", "About", "রবীন্দ্রনাথ ঠাকুরের সকল রকম রচনা সমগ্র পেতে এখনি ডাউনলোড করুন অ্যাপটি", intenttwo, 102);
    ...
    public void notificationOne(Context context, String title, String message, String about, String dec, Intent intent, int reqCode) {
        //    SharedPreferenceManager sharedPreferenceManager = SharedPreferenceManager.getInstance(context);


        RemoteViews lay_one = new RemoteViews(getPackageName(), R.layout.custom_notification_one);
        RemoteViews lay_two = new RemoteViews(getPackageName(), R.layout.custom_notification_two);


        lay_one.setTextViewText(R.id.layoutOneTitle, title);
        lay_one.setTextViewText(R.id.layoutoneSecTitle, message);
        lay_one.setImageViewResource(R.id.layoutOneIcon, R.drawable.zafar);


        lay_two.setTextViewText(R.id.layoutTwoTitle, title);
        lay_two.setTextViewText(R.id.layoutTwoSecTitle, message);
        lay_two.setTextViewText(R.id.layoutTwoDec, dec);
        lay_two.setImageViewResource(R.id.LayoutTwoIcon, R.drawable.zafar);
        ...
        String CHANNEL_ID = "অন্যান্য জনপ্রিয় অ্যাপস";// The id of the channel.
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(R.drawable.zafar)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "অন্যান্য জনপ্রিয় অ্যাপস";// The user-visible name of the channel.
    ...
    public void notificationtwo(Context context, String title, String message, String about, String dec, Intent intent, int reqCode) {
        //    SharedPreferenceManager sharedPreferenceManager = SharedPreferenceManager.getInstance(context);
        ...
        lay_one.setTextViewText(R.id.layoutOneTitle, title);
        lay_one.setTextViewText(R.id.layoutoneSecTitle, message);
        lay_one.setImageViewResource(R.id.layoutOneIcon, R.drawable.robindro);


        lay_two.setTextViewText(R.id.layoutTwoTitle, title);
        lay_two.setTextViewText(R.id.layoutTwoSecTitle, message);
        lay_two.setTextViewText(R.id.layoutTwoDec, dec);
        lay_two.setImageViewResource(R.id.LayoutTwoIcon, R.drawable.robindro);


        PendingIntent pendingIntent = PendingIntent.getActivity(context, reqCode, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE);
        String CHANNEL_ID = "অন্যান্য জনপ্রিয় অ্যাপস ";// The id of the channel.
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(R.drawable.robindro)
                .setCustomContentView(lay_one)
                .setCustomBigContentView(lay_two)
                .setAutoCancel(false)
                .setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION))
